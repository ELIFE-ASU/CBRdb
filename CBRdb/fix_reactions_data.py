...
def fix_reactions_data(r_file="../data/kegg_data_R.csv",
    ...
    df_final.loc[:,'balanced_els_stars'] = (dfs_check['elements_L'] == dfs_check['elements_R']).all(axis=1)
    df_final.loc[:,'balanced_els_stars'] = df_final['balanced_els_stars'].fillna(False) #Only var coeffs have NaNs
...
def get_stoichiometry(data_r, formula_table=None, dfs=None, data_c=None):
    """
