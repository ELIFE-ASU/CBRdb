...
def calculate_free_energy_formation_cc(kegg_C_ids=None,
    ...
    elif isinstance(kegg_C_ids, (list, set, tuple, dict)):
        ids = pd.Index(sorted(kegg_C_ids))
    elif isinstance(kegg_C_ids, (pd.DataFrame, pd.Series)):
        ids = kegg_C_ids.index
